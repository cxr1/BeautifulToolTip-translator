; FileInstall, BTT.ahk, %A_ScriptDir%, 1
; FileInstall, Gdip_All.ahk, %A_ScriptDir%, 1
; FileInstall, NonNull.ahk, %A_ScriptDir%, 1

#If (MouseIsOveRControl("MSTaskListWClass1"))
i := Monitor.GetBrightness().Current
Wheelup::
i += 5
changeCurrent(i)
Return
...
btt(Monitor.GetBrightness().Current,,,,"Style2",{Transparent:v})
Sleep, 150
btt()
Return
}
